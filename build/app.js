...
var template = require('./templates/hello-name.hbs');

function HelloName(opts) {
	if (!(this instanceof HelloName)) {
		return new HelloName(opts);
	}
}

HelloName.prototype.getMessage = function(name) {
	return template({name: name});
};

module.exports = HelloName;

},{"./templates/hello-name.hbs":3}],2:[function(require,module,exports){
'use strict';

var template = require('./templates/hello-world.hbs');

function HelloWorld(opts) {
	if (!(this instanceof HelloWorld)) {
		return new HelloWorld(opts);
	}
}
...
},{"./templates/hello-world.hbs":4}],3:[function(require,module,exports){
